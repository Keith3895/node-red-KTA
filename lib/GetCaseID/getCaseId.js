...
module.exports = function (RED) {
    function KTAGetCaseIdentityNode(config) {
        ...
        node.on('input', function (msg) {
            ...
            const caseReference = msg.caseReference || config.caseReference;
            url = remove_slash(url);
            url = `${url}/TotalAgility/Services/Sdk/CaseService.svc/json/GetCaseIdentity`;
            let ntlmOptions = {
            ...
            let body = {
                "sessionId": sessionId,
                "caseIdentity": {
                    "CaseId": "", // pass job id to get case id
    ...
    RED.nodes.registerType('KTA-GetCaseIdentity', KTAGetCaseIdentityNode);
}