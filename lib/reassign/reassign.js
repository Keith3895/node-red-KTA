...
module.exports = function (RED) {
    function reassign(config) {
        ...
        node.on('input', function (msg) {
            ...
            let body = {
                ...
                "newResource": msg.newResource,
                "originalResource": msg.originalResource
            };
            url = `${url}/TotalAgility/Services/Sdk/ActivityService.svc/json/ReassignActivity`;
            let ntlmOptions = {
    ...
    RED.nodes.registerType('KTA-reassign', reassign);
}