...
module.exports = function (RED) {
    function KTAactivityPagingNode(config) {
        ...
        node.on('input', function (msg) {
            ...
            let PageDirection = msg.pageDirection || config.pageDirection;
            let from = msg.StartDueDateTime || config.StartDueDateTime; // null for first page
            let to = msg.StartPendingTime || config.StartPendingTime; // null for first page
