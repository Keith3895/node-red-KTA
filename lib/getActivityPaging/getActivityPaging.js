...
module.exports = function (RED) {
    function KTAactivityPagingNode(config) {
        ...
        node.on('input', function (msg) {
            ...
            let PageDirection = msg.pageDirection ? msg.pageDirection : 10; // default page size to 10
            let from = msg.StartDueDateTime ? msg.StartDueDateTime : null;  // null for first page
            let to = msg.StartPendingTime ? msg.StartPendingTime : null;    // null for first page
            ...
            let body = {
                ...
                "jobActivityFilter": {
                    ...
                    "StartDueDateTime": from ? from : null,
                    "StartPendingTime": to ? to : null,
