...
module.exports = function(RED) {
    function KTAactivityNode(config) {
        ...
        node.on('input', function(msg) {
            ...
            let queryId = msg.queryId || config.queryId;
            let queryName = msg.queryName || config.queryName;
            ...
            let retrievalLimit = msg.totalRecords;
            let pageDirection = msg.pageDirection;
            url = remove_slash(url);
            if (msg.jobQueue)
                url = `${url}/TotalAgility/Services/Sdk/JobService.svc/json/GetJobsWithQuery2`;
            else
                url = `${url}/TotalAgility/Services/Sdk/ActivityService.svc/json/GetActivitiesWithQuery`;
            let ntlmOptions = {
            ...
            let body = {
                ...
                "jobActivityFilter": {
                    "MaxActivitiesCount": retrievalLimit,
    ...
    RED.nodes.registerType('KTA-activityList', KTAactivityNode);
}