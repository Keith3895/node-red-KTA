...
module.exports = function (RED) {
    function KTAcompleteNode(config) {
        ...
        node.on('input', function (msg) {
            ...
            let CompletePendingActivity = typeof msg.CompletePendingActivity != 'undefined' ? msg.CompletePendingActivity : config.CompletePendingActivity;
            ...
            if (CompletePendingActivity)
                url = `${url}/TotalAgility/Services/Sdk/ActivityService.svc/json/CompletePendingActivity`;
            else
                url = `${url}/TotalAgility/Services/Sdk/ActivityService.svc/json/CompleteActivity`;
            let ntlmOptions = {
    ...
    RED.nodes.registerType('KTA-complete', KTAcompleteNode);
}